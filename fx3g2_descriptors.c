...
USB3_DESC_ATTRIBUTES uint8_t CyFxUSB30DeviceDscr[32] =
{
...
USB3_DESC_ATTRIBUTES uint8_t CyFxUSBBOSDscr[32] =
{
...
void Cy_App_MakeConfigDescriptor (void)
{
    ...
    ssDscLen = 9 + 9 + 13 * (CY_USB_NUM_ENDP_CONFIGURED - 1);
    ...
    CyFxUSBSSConfigDscr[idx++] = 0x00;
    CyFxUSBSSConfigDscr[idx++] = 0x00;
    CyFxUSBSSConfigDscr[idx++] = (CY_USB_NUM_ENDP_CONFIGURED - 1 );
    ...
    for (ep = 1; ep < CY_USB_NUM_ENDP_CONFIGURED; ep++) {
        ...
        CyFxUSBSSConfigDscr[idx++] = (CY_SLFF_STREAM_EP_BURST-1); /* Max no. of packets in a Burst */
        CyFxUSBSSConfigDscr[idx++] = 0x00;
        CyFxUSBSSConfigDscr[idx++] = 0x00;
        CyFxUSBSSConfigDscr[idx++] = 0x00;
    }
    ...
    idx      = 0;
    hsDscLen = 9 + 9 + 7 * (CY_USB_NUM_ENDP_CONFIGURED - 1 );
    ...
    CyFxUSBHSConfigDscr[idx++] = 0x00;
    CyFxUSBHSConfigDscr[idx++] = 0x00;
    CyFxUSBHSConfigDscr[idx++] = (CY_USB_NUM_ENDP_CONFIGURED -1 );
